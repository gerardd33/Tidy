...
instance Print TidyParser.Abs.ValSBody where
  prt i e = case e of
    TidyParser.Abs.ValSBody valuedecls -> prPrec i 0 (concatD [doc (showString "{"), prt 0 valuedecls, doc (showString "}")])
...
instance Print TidyParser.Abs.VarSBody where
  prt i e = case e of
    TidyParser.Abs.VarSBody valuedecls -> prPrec i 0 (concatD [doc (showString "{"), prt 0 valuedecls, doc (showString "}")])
...
instance Print TidyParser.Abs.Expr where
  prt i e = case e of
    TidyParser.Abs.ELiteral literal -> prPrec i 7 (concatD [prt 0 literal])
    TidyParser.Abs.ELocalValue valueident -> prPrec i 7 (concatD [prt 0 valueident])
    TidyParser.Abs.EUnaryNot expr -> prPrec i 6 (concatD [doc (showString "not"), prt 7 expr])
    TidyParser.Abs.EUnaryMinus expr -> prPrec i 6 (concatD [doc (showString "-"), prt 7 expr])
    ...
    TidyParser.Abs.ELocalFunctionCall functioncall -> prPrec i 5 (concatD [doc (showString "local"), prt 0 functioncall])
    TidyParser.Abs.ELocalActionCall actioncall -> prPrec i 5 (concatD [doc (showString "local"), prt 0 actioncall])
...
instance Print TidyParser.Abs.LocalValueDecl where
  prt i e = case e of
    TidyParser.Abs.LocalVDecl valuedecl -> prPrec i 0 (concatD [doc (showString "value"), prt 0 valuedecl, doc (showString ";")])

instance Print TidyParser.Abs.LambdaFunction where
  prt i e = case e of
    TidyParser.Abs.LambdaFunctionOneLine valuedecls expr -> prPrec i 0 (concatD [doc (showString "get"), doc (showString "("), prt 0 valuedecls, doc (showString ")"), doc (showString "->"), prt 0 expr, doc (showString ";")])
...
instance Print TidyParser.Abs.LambdaAction where
  prt i e = case e of
    TidyParser.Abs.LambdaActionOneLine valuedecls expr -> prPrec i 0 (concatD [doc (showString "do"), doc (showString "("), prt 0 valuedecls, doc (showString ")"), doc (showString "->"), prt 0 expr, doc (showString ";")])
...
instance Print TidyParser.Abs.FunctionCall where
  prt i e = case e of
    TidyParser.Abs.FunctionCallNoArgs functionident -> prPrec i 0 (concatD [doc (showString "."), prt 0 functionident])
    TidyParser.Abs.FunctionCallWithArgs functionident functionarguments -> prPrec i 0 (concatD [doc (showString "."), prt 0 functionident, doc (showString "("), prt 0 functionarguments, doc (showString ")")])

instance Print TidyParser.Abs.ActionCall where
  prt i e = case e of
    TidyParser.Abs.ActionCallNoArgs functionident -> prPrec i 0 (concatD [doc (showString "#"), prt 0 functionident])
    TidyParser.Abs.ActionCallWithArgs functionident functionarguments -> prPrec i 0 (concatD [doc (showString "#"), prt 0 functionident, doc (showString "("), prt 0 functionarguments, doc (showString ")")])
